'''
This module contains functionality for loading frequency normalisation factors. It handles loading
precomputed per-frequency scale factors which may be conditioned on temperature and protein size 
bins, as well as DC baselines.

The loaded factors are used to normalize the spectral representation of protein coordinates.
'''
