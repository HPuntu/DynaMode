...
from disco.spectral.adapters import DCT, DFT
...
class CoordinateRepresentation:
    ...
    def forward(self, coords, native_coords, mask=None, *, return_context=False):
        """Encode absolute aligned coordinates `(B,T,L,C)` into model coordinates."""
...
class SpectralRepresentationPipeline:
    ...
    The legacy ``SpectralAdapter`` remains available, but this class is the
    training/inference-facing object. It owns:
